class PurchaseRecordShippingDestination
  ...
  def save
    ...
    shipping_destination.create(post_code: post_code, prefecture_id: prefecture_id, city: city, street_address: street_address, phone_number: phone_number, purchase_record_id: purchase_record_id)
  end
end